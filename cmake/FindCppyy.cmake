...
if(CPPYY_MODULE_PATH)
    ...
    #
    get_filename_component(Cppyy_DIR ${CPPYY_MODULE_PATH} DIRECTORY)
    #
...
set(ROOT_genreflex_CMD ${Cppyy_DIR}/bin/genreflex)

include(FindPackageHandleStandardArgs)
FIND_PACKAGE_HANDLE_STANDARD_ARGS(Cppyy
                                  REQUIRED_VARS Cppyy_DIR Cppyy_INCLUDE_DIRS CPPYY_MODULE_PATH
...
function(cppyy_add_bindings pkg pkg_version author author_email)
    ...
    # TODO: temporary hack: rather than an external dependency,
    # enable libclang in the local build.
    #
    find_program(
            Cppyygen_EXECUTABLE
            "cppyy-generator"
