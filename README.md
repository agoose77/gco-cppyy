...
[![Build Status](https://travis-ci.org/agoose77/gco-cppyy.svg?branch=master)](https://travis-ci.org/agoose77/gco-cppyy)

This project is set of Python bindings for gco using
